...
export class Backend implements backendInterface {
    ...
    async getAllPublishedVideos(): Promise<Array<[bigint, Video]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPublishedVideos();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllTextbooks(): Promise<Array<[bigint, Textbook]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTextbooks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async insertTextbook(arg0: Textbook): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.insertTextbook(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async insertVideo(arg0: Video): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.insertVideo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
